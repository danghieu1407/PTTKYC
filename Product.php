...
<head>
   ...
   <?php include 'back/DialogAdd.php';
...
<body>
    <div class="container">
        ...
        <button id="button-logout" type="button"> <a href="back/LogoutProcess.php">Đăng Xuất</a> </button>
        <button type="button" id="button-add" class="btn btn-primary font-weight-bold" data-toggle="modal" data-target="#AddProduct">
            Thêm sản phẩm
        </button>
        <?php include 'back/NumProduct.php' ?>
        <?php if ($NumProduct > 1) { ?>
        ...
        <div class="product">
            <table>
                ...
                <?php include 'back/LoadProductProcess.php' ?>
            </table>
        </div>
    </div>
</body>
